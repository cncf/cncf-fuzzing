...
mv $SRC/distribution/internal/client/repository_test.go \
   $SRC/distribution/internal/client/repository_test_fuzz.go
...
mv $CNCFPATH/authchallenge_fuzzer.go $SRC/distribution/internal/client/auth/challenge/
