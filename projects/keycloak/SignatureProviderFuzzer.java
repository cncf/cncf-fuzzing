...
import org.keycloak.crypto.ES256SignatureProviderFactory;
import org.keycloak.crypto.ES384SignatureProviderFactory;
import org.keycloak.crypto.ES512SignatureProviderFactory;
...
import org.keycloak.crypto.PS256SignatureProviderFactory;
import org.keycloak.crypto.PS384SignatureProviderFactory;
import org.keycloak.crypto.PS512SignatureProviderFactory;
import org.keycloak.crypto.RS256SignatureProviderFactory;
import org.keycloak.crypto.RS384SignatureProviderFactory;
import org.keycloak.crypto.RS512SignatureProviderFactory;
...
public class SignatureProviderFuzzer {
  private static MockObject mockObject;

  public static void fuzzerTestOneInput(FuzzedDataProvider data) throws Exception {
    try {
      SignatureProviderFactory factory = null;
      ...
      switch (choice) {
        case 1:
          factory = new ES256SignatureProviderFactory();
          break;
        case 2:
          factory = new ES384SignatureProviderFactory();
          break;
        case 3:
          factory = new ES512SignatureProviderFactory();
          break;
        case 4:
          factory = new HS256SignatureProviderFactory();
          break;
        case 5:
          factory = new HS384SignatureProviderFactory();
          break;
        case 6:
          factory = new HS512SignatureProviderFactory();
          break;
        case 7:
          factory = new PS256SignatureProviderFactory();
          break;
        case 8:
          factory = new PS384SignatureProviderFactory();
          break;
        case 9:
          factory = new PS512SignatureProviderFactory();
          break;
        case 10:
          factory = new RS256SignatureProviderFactory();
          break;
        case 11:
          factory = new RS384SignatureProviderFactory();
          break;
        case 12:
          factory = new RS512SignatureProviderFactory();
          break;
      }

      SignatureSignerContext signer = factory.create(mockObject.getSession()).signer();
      signer.sign(data.consumeRemainingAsBytes());
  ...
  private static class MockObject {
    ...
    private void mockKeyManager() {
      // Create and mock KeyManager with static data
    ...
    private void mockKeycloakSession() {
      ...
      Mockito.doReturn(keyManager).when(session).keys();
    }
    ...
    private void randomizeKeyManager(FuzzedDataProvider data) {}
