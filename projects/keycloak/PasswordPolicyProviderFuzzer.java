...
import org.keycloak.policy.RecoveryCodesWarningThresholdPasswordPolicyProviderFactory;
...
/**
 * This fuzzer creates objects for different subclasses of the PasswordPolicyProvider and invoke
 * their validate method with the needed mock objects.
 */
public class PasswordPolicyProviderFuzzer {
  private static MockObject mockObject;

  public static void fuzzerTestOneInput(FuzzedDataProvider data) {
    try {
      PasswordPolicyProviderFactory factory = null;
      ...
      switch (choice) {
        case 1:
          factory = new BlacklistPasswordPolicyProviderFactory();
          break;
        case 2:
          factory = new DigitsPasswordPolicyProviderFactory();
          break;
        case 3:
          factory = new ForceExpiredPasswordPolicyProviderFactory();
          break;
        case 4:
          factory = new HashIterationsPasswordPolicyProviderFactory();
          break;
        case 5:
          factory = new HistoryPasswordPolicyProviderFactory();
          break;
        case 6:
          factory = new LengthPasswordPolicyProviderFactory();
          break;
        case 7:
          factory = new LowerCasePasswordPolicyProviderFactory();
          break;
        case 8:
          factory = new MaximumLengthPasswordPolicyProviderFactory();
          break;
        case 9:
          factory = new NotEmailPasswordPolicyProviderFactory();
          break;
        case 10:
          factory = new NotUsernamePasswordPolicyProviderFactory();
          break;
        case 11:
          factory = new RecoveryCodesWarningThresholdPasswordPolicyProviderFactory();
          break;
        case 12:
          factory = new RegexPatternsPasswordPolicyProviderFactory();
          break;
        case 13:
          factory = new SpecialCharsPasswordPolicyProviderFactory();
          break;
        case 14:
          factory = new UpperCasePasswordPolicyProviderFactory();
          break;
      }
